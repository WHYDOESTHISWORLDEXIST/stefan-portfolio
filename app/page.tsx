  ...
  return (
    <main>
      <nav className="nav shell" aria-label="Main navigation">
        <a className="wordmark" href="#top" aria-label="Stefa, home">S<span>.</span></a>
      ...
      <section className="hero shell" id="top">
        ...
        <h1>I turn curiosity<br />into <em>things that work.</em></h1>
        <div className="heroBottom"><p>I&apos;m Stefa, an aspiring developer exploring the space where thoughtful design meets useful technology.</p><a className="roundLink" href="#work" aria-label="See my work">↓</a></div>
        <div className="orb orbOne" aria-hidden="true" /><div className="orb orbTwo" aria-hidden="true" />
      </section>
      <section className="about shell" id="about">
        <p className="sectionLabel">A little about me</p>
      ...
      <section className="work shell" id="work">
        <div className="sectionHead"><div><p className="sectionLabel">Selected work</p><h2>Projects & experiments</h2></div><p>A growing collection. Replace these cards with your real projects as you build them.</p></div>
      ...
      <section className="contact" id="contact"><div className="shell contactInner">
        <p className="sectionLabel light">Start a conversation</p><h2>Have an idea?<br /><em>Let&apos;s make it real.</em></h2>
