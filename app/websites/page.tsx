...
export default function WebsitesPage() {
  return (
    <TopicShell eyebrow="Live on the web" title="Websites launched" intro="Sites I have designed, built, and made available for people to use.">
      <a className="topicEntry topicEntryLink" href="https://stefan-portfolio.stefan-cutler.workers.dev/" target="_blank" rel="noopener noreferrer"><span>01</span><div><h2>Personal portfolio</h2><p>2026 · Next.js · Cloudflare Workers</p><p className="topicNote">This evolving record of my projects, education, published work, interests, and technical growth.</p><strong>Visit website ↗</strong></div></a>
